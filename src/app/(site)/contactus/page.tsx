      ...
      <div className='mb-16'>
        ...
        <div className='text-center'>
          ...
          <p className='text-xm font-normal tracking-tight text-black/50 dark:text-white/50 leading-6'>
            Разрабатываем измерительное оборудование под ключ. Наша команда экспертов предлагает
            индивидуальные решения с учетом ваших технических требований.
          </p>
        </div>
      </div>
      {/* form */}
