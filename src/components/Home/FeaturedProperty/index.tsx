        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-10">
            ...
            <p className="text-base text-dark/50 dark:text-white/50">
              Современные технологические решения для промышленных нужд. Разработка измерительного оборудования по индивидуальным требованиям с полным соответствием ГОСТ и международным стандартам.
            </p>
            <div className="grid grid-cols-2 gap-10">
              <div className="flex items-center gap-4">
                <div className="bg-dark/5 dark:bg-white/5 p-2.5 rounded-[6px]">
                  <Icon icon="ph:cpu" width={24} height={24} className="text-primary" />
                </div>
                <h6 className="">Высокая точность</h6>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-dark/5 dark:bg-white/5 p-2.5 rounded-[6px]">
                  <Icon icon="ph:microchip" width={24} height={24} className="text-primary" />
                </div>
                <h6 className="">Автономность</h6>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-dark/5 dark:bg-white/5 p-2.5 rounded-[6px]">
                  <Icon icon="ph:gauge" width={24} height={24} className="text-primary" />
                </div>
                <h6 className="">ГОСТ стандарты</h6>
              </div>
              <div className="flex items-center gap-4">
                <div className="bg-dark/5 dark:bg-white/5 p-2.5 rounded-[6px]">
                  <Icon icon="ph:git-branch" width={24} height={24} className="text-primary" />
                </div>
                <h6 className="">Гарантия качества</h6>
              </div>
            </div>
